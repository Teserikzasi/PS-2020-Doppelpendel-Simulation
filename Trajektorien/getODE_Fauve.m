...
f2= ((m2*s2^2 + J2)*(m2*l1^2 + m1*s1^2 + J1)*(sin(x3)*(l1*m2 + m1*s1)*x4^2 + m2*s2*sin(x5)*x6^2 - u + d0*x2) - cos(x3)*(m2*s2^2 + J2)*(l1*m2 + m1*s1)*(- l1*m2*s2*sin(x3 - x5)*x6^2 + d2*x6 - x4*(d1 + d2) + g*sin(x3)*(l1*m2 + m1*s1)) - m2*s2*cos(x5)*(m2*l1^2 + m1*s1^2 + J1)*(l1*m2*s2*sin(x3 - x5)*x4^2 + d2*x4 - d2*x6 + g*m2*s2*sin(x5)) - l1^2*m2^2*s2^2*cos(x3 - x5)^2*(sin(x3)*(l1*m2 + m1*s1)*x4^2 + m2*s2*sin(x5)*x6^2 - u + d0*x2) + l1*m2^2*s2^2*cos(x3 - x5)*cos(x5)*(- l1*m2*s2*sin(x3 - x5)*x6^2 + d2*x6 - x4*(d1 + d2) + g*sin(x3)*(l1*m2 + m1*s1)) + l1*m2*s2*cos(x3 - x5)*cos(x3)*(l1*m2 + m1*s1)*(l1*m2*s2*sin(x3 - x5)*x4^2 + d2*x4 - d2*x6 + g*m2*s2*sin(x5)))/(cos(x3)^2*(m2*s2^2 + J2)*(l1*m2 + m1*s1)^2 - (m2*s2^2 + J2)*(m0 + m1 + m2)*(m2*l1^2 + m1*s1^2 + J1) + m2^2*s2^2*cos(x5)^2*(m2*l1^2 + m1*s1^2 + J1) + l1^2*m2^2*s2^2*cos(x3 - x5)^2*(m0 + m1 + m2) - 2*l1*m2^2*s2^2*cos(x3 - x5)*cos(x3)*cos(x5)*(l1*m2 + m1*s1));
f4= -((m2*s2^2 + J2)*(m0 + m1 + m2)*(- l1*m2*s2*sin(x3 - x5)*x6^2 + d2*x6 - x4*(d1 + d2) + g*sin(x3)*(l1*m2 + m1*s1)) - m2^2*s2^2*cos(x5)^2*(- l1*m2*s2*sin(x3 - x5)*x6^2 + d2*x6 - x4*(d1 + d2) + g*sin(x3)*(l1*m2 + m1*s1)) - cos(x3)*(m2*s2^2 + J2)*(l1*m2 + m1*s1)*(sin(x3)*(l1*m2 + m1*s1)*x4^2 + m2*s2*sin(x5)*x6^2 - u + d0*x2) - l1*m2*s2*cos(x3 - x5)*(m0 + m1 + m2)*(l1*m2*s2*sin(x3 - x5)*x4^2 + d2*x4 - d2*x6 + g*m2*s2*sin(x5)) + l1*m2^2*s2^2*cos(x3 - x5)*cos(x5)*(sin(x3)*(l1*m2 + m1*s1)*x4^2 + m2*s2*sin(x5)*x6^2 - u + d0*x2) + m2*s2*cos(x3)*cos(x5)*(l1*m2 + m1*s1)*(l1*m2*s2*sin(x3 - x5)*x4^2 + d2*x4 - d2*x6 + g*m2*s2*sin(x5)))/(cos(x3)^2*(m2*s2^2 + J2)*(l1*m2 + m1*s1)^2 - (m2*s2^2 + J2)*(m0 + m1 + m2)*(m2*l1^2 + m1*s1^2 + J1) + m2^2*s2^2*cos(x5)^2*(m2*l1^2 + m1*s1^2 + J1) + l1^2*m2^2*s2^2*cos(x3 - x5)^2*(m0 + m1 + m2) - 2*l1*m2^2*s2^2*cos(x3 - x5)*cos(x3)*cos(x5)*(l1*m2 + m1*s1));
f6= (cos(x3)^2*(l1*m2 + m1*s1)^2*(l1*m2*s2*sin(x3 - x5)*x4^2 + d2*x4 - d2*x6 + g*m2*s2*sin(x5)) - (m0 + m1 + m2)*(m2*l1^2 + m1*s1^2 + J1)*(l1*m2*s2*sin(x3 - x5)*x4^2 + d2*x4 - d2*x6 + g*m2*s2*sin(x5)) + m2*s2*cos(x5)*(m2*l1^2 + m1*s1^2 + J1)*(sin(x3)*(l1*m2 + m1*s1)*x4^2 + m2*s2*sin(x5)*x6^2 - u + d0*x2) + l1*m2*s2*cos(x3 - x5)*(m0 + m1 + m2)*(- l1*m2*s2*sin(x3 - x5)*x6^2 + d2*x6 - x4*(d1 + d2) + g*sin(x3)*(l1*m2 + m1*s1)) - m2*s2*cos(x3)*cos(x5)*(l1*m2 + m1*s1)*(- l1*m2*s2*sin(x3 - x5)*x6^2 + d2*x6 - x4*(d1 + d2) + g*sin(x3)*(l1*m2 + m1*s1)) - l1*m2*s2*cos(x3 - x5)*cos(x3)*(l1*m2 + m1*s1)*(sin(x3)*(l1*m2 + m1*s1)*x4^2 + m2*s2*sin(x5)*x6^2 - u + d0*x2))/(cos(x3)^2*(m2*s2^2 + J2)*(l1*m2 + m1*s1)^2 - (m2*s2^2 + J2)*(m0 + m1 + m2)*(m2*l1^2 + m1*s1^2 + J1) + m2^2*s2^2*cos(x5)^2*(m2*l1^2 + m1*s1^2 + J1) + l1^2*m2^2*s2^2*cos(x3 - x5)^2*(m0 + m1 + m2) - 2*l1*m2^2*s2^2*cos(x3 - x5)*cos(x3)*cos(x5)*(l1*m2 + m1*s1));
