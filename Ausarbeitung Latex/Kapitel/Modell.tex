...
\[
	K_{UI} = 1,87 \ \frac{A}{V} \ .
\]
Der Wert ist allerdings bereits eine Vereinfachung, da Messungen von franke \cite{franke} gezeigt haben, dass die reale Verstärkung am Versuchsstand eine leichte Richtungsabhängigkeit bezüglich des Vorzeichens aufweist.
