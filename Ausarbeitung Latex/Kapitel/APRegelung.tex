...
Die Verstärkung $K$ wird durch Lösen des LQ-Problems bestimmt \cite{AdamyRT2}. Parameter für den Entwurf sind somit die Matrix 
$\mat{Q}=\diaga \begin{matrix} q_1 & q_2 & q_3 & q_4 & q_5 & q_6 \end{matrix}$
...
Der AP-Regler ist somit nur in der Umgebung der Ruhelage gültig und kann zu großen Abweichungen möglicherweise nicht ausregeln.
...
Ist der AP-Regler nach dem \bss\ ausgelegt, gibt dieser als Stellgröße eine Sollbeschleunigung \asoll\ vor. 
Aus dieser muss eine geforderte Kraft vom Motor bestimmt werden.
...
In \cite{chang} wird die Vorsteuerung folgendermaßen berechnet:
	\[
	\fvorst=m \asoll + \Fco \, \sign{\vsoll} + d_0 \xop
\]

\subsubsection{a/v-Regler}
Die Sollgeschwindigkeit \vsoll\ wird aus Integration von \asoll\ berechnet.
Sie wird zum Soll/Ist-Vergleich mit der realen \bzw geschätzten Geschwindigkeit \xop\ verwendet.
...
In dieser Arbeit wird ein Wert von 150 angenommen und der Parameter nicht weiter untersucht, da es in der Simulation nur geringe Abweichungen von der Sollgeschwindigkeit gibt.
...
In dieser Zeit übertrifft \fav\ daher \fvorst\ und die Stellgröße geht somit praktisch in die falsche Richtung, was die Regelung sehr schnell instabil werden lassen kann.
