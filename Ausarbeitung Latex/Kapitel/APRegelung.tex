...
Im Ordner \path{Regelung/Reglerparameter} befinden sich folgenden Datensätze:
\begin{itemize}
...
Die Funktionen zu den \xots s (siehe folgender Abschnitt) und den darauf aufbauenden Tests befinden sich im Ordner \path{Regelung/x0_Tests}.
