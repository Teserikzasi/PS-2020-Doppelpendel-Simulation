...
%%%%%%%%%%%%%%%%%%%
\usepackage[backend=bibtex ,bibencoding=utf8]{biblatex}   % Literaturverzeichnis      % backend=biber
...
\author[T. Gebhard \and F. Tesar]{Tobias Gebhard \and Frederik Tesar}%optionales Argument ist die Signatur, 
...
\input{./inc/mymacros.tex}

\input{./Kapitel/Einleitung.tex}
\input{./Kapitel/Grundlagen.tex}
\input{./Kapitel/Modell.tex}
\input{./Kapitel/APRegelung.tex}



%\input{./inc/Einfuehrung.tex}
%\input{./inc/Tipps.tex}
%\input{./inc/Hinweise_LaTeX.tex}
%\input{./inc/Verzeichnisstruktur.tex}
