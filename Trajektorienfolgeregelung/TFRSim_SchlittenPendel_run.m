...
Auswertung(out1);
plotanimate(out1, [trajName '_' convertStringsToChars(sol) '_TFR'], 'Trajektorien_Tests')
...
Auswertung(out2);
plotanimate(out2, [trajName '_' convertStringsToChars(sol) '_TFR'], 'Trajektorien_Tests')
...
Auswertung(out3);
plotanimate(out3, [trajName '_' convertStringsToChars(sol) '_TFR'], 'Trajektorien_Tests')
