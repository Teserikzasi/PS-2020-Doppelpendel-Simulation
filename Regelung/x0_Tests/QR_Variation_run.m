...
resB2R = QR_Variation(2, AP_QR_20_neu_Beob(), 'R', logspace(-3,1,7) )
resB2Q = QR_Variation(2, AP_QR_20_neu_Beob(), 'Q1', logspace(-2,2,7), 3 )

resB3Q = QR_Variation(3, AP_QR_20_neu_Beob(), 'Q1', logspace(-2,2,7), 1:3 )

resB4Q = QR_Variation(4, AP_QR_20_neu_Beob(), 'Q1', logspace(-2,2,7), 2:3 )
